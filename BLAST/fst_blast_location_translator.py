...
def main(argv):
	try:
		opts,args = getopt.getopt(argv,'hf:b:o:t:s:',)
	except getopt.GetOptError:
		print "fst_blast_location_translator.py -f <path to Stacks fst (between two populations) file to be translated> -b <path to blast xml file> -o <path to output file (e.g. ./output.vcf)> -t <path to desired tag id output file (e.g. ./output.tag_id.txt)> -s <if 1, only a single snp per locus will be written - if 0 (default) all loci will be translated>"
		sys.exit(2)
