...
def main(argv):
	try:
		opts,args = getopt.getopt(argv,'hl:u:s:p:o:m:P:M:v:',)
	except getopt.GetOptError:
		print "catalog_read_pair.py -l <mysql host> -u <mysql user> -p <mysql password> -s <Stacks database name> -o <path to output directory (default .)> -m <Popmap file> -P <Plink ped file> -M <Plink map file> -v <VCF file>"
		sys.exit(2)
